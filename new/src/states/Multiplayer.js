...
multiplayer.prototype = {
	create: function () {
  	...
  	this.title.anchor.setTo(0.5,0.5);
		...
		//menu buttons
		menuArray[0] = new Button(w2, 300, null, '<    ' + (this.nPlayers + 1) + ' players    >', 0, this.inc, this, this.game);
		menuArray[0].create();
		...
		this.game.input.keyboard.addKey(Phaser.Keyboard.LEFT).onDown.add(this.dec, this);
		this.game.input.keyboard.addKey(Phaser.Keyboard.RIGHT).onDown.add(this.inc, this);
